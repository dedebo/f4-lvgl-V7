...
#define	W25Q128_CS 		PBout(14)  		//W25Q128的片选信号
...
u16  W25Q128_ReadID(void);  	    		//读取FLASH ID
...
void W25Q128_Write_NoCheck(u8* pBuffer,u32 WriteAddr,u16 NumByteToWrite); //不检验写
